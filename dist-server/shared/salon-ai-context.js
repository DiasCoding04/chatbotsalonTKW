...
opts) {
    ...
    const validMarkerKeys = markerKeys.filter((key) => groupsByKey.has(key) && (!allowedKeys.length || allowedKeys.includes(key)));
...
export function inferBranchForFacebookPage(page, pageOrderIndex) {
